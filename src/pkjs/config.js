var customCSS = [
  ":root {",
"  --bg: #F0F2F5; --card: #FFFFFF; --text-pri: #111B21;",
"  --text-sec: #54656F; --border: #E9EDEF; --input-border: #8696A0;",
"  --accent: #00A884; --highlight: #55FFAA;",
"}",
"@media (prefers-color-scheme: dark) {",
"  :root {",
"    --bg: #111B21; --card: #202C33; --text-pri: #E9EDEF;",
"    --text-sec: #8696A0; --border: #222E35; --input-border: #54656F;",
"  }",
"}",
...
},
{
  "type": "section",
  "items": [
    { "type": "heading", "defaultValue": "Connection Setup" },
    { "type": "input", "messageKey": "ServerURL", "defaultValue": "", "label": "Server URL", "description": "Your Raspberry Pi's IP or Tailscale address (e.g., http://192.168.0.30:3000)" }
  ]
},
{
  "type": "section",
  "items": [
    { "type": "heading", "defaultValue": "Memory & Performance" },
    { "type": "slider", "messageKey": "ChatLimit", "defaultValue": 8, "label": "Max Chats to Load", "min": 1, "max": 15, "step": 1 },
    { "type": "slider", "messageKey": "MessageLimit", "defaultValue": 10, "label": "Messages per Chat", "min": 1, "max": 20, "step": 1 }
  ]
},
{
  "type": "section",
  "items": [
    { "type": "heading", "defaultValue": "Filters" },
    { "type": "toggle", "messageKey": "HideGroupChats", "label": "Hide Group Chats", "defaultValue": false },
    { "type": "toggle", "messageKey": "UnreadOnly", "label": "Show Unread Only", "defaultValue": false }
  ]
},
{
  "type": "section",
  "items": [
    { "type": "heading", "defaultValue": "Theme Colors" },
    { "type": "toggle", "messageKey": "DarkMode", "label": "Enable Dark Mode", "defaultValue": false },
    { "type": "color", "messageKey": "THEME_ME", "defaultValue": "00AA55", "label": "My Messages Color" },
    { "type": "color", "messageKey": "THEME_OTHER", "defaultValue": "AAAAAA", "label": "Other Messages Color" }
  ]
},
{
  "type": "section",
  "items": [
    { "type": "heading", "defaultValue": "Custom Quick Replies" },
    { "type": "input", "messageKey": "Reply1", "defaultValue": "Yes", "label": "Reply Slot 1", "attributes": { "maxlength": 30 } },
    { "type": "input", "messageKey": "Reply2", "defaultValue": "No", "label": "Reply Slot 2", "attributes": { "maxlength": 30 } },
    { "type": "input", "messageKey": "Reply3", "defaultValue": "I'll call you later", "label": "Reply Slot 3", "attributes": { "maxlength": 30 } },
    { "type": "input", "messageKey": "Reply4", "defaultValue": "OK", "label": "Reply Slot 4", "attributes": { "maxlength": 30 } },
    { "type": "input", "messageKey": "Reply5", "defaultValue": "On my way!", "label": "Reply Slot 5", "attributes": { "maxlength": 30 } },
    { "type": "input", "messageKey": "Reply6", "defaultValue": "Can't talk right now.", "label": "Reply Slot 6", "attributes": { "maxlength": 30 } }
  ]
},
{
  "type": "submit",
